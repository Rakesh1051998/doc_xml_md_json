...
def xml_to_md(xml_path, md_path):
    ...
    def write_section(section, md_lines, parent=None):
        ...
        for item, is_bold in section.content:
            ...
            ) or (is_bold and is_heading_like):
...
if __name__ == "__main__":
    input_directory = "/home/Comptroller_and_Auditor_General/uma_data_xml"
    output_directory = "/home/Comptroller_and_Auditor_General/uma_data_md"
